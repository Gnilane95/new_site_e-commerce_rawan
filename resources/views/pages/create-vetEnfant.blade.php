<x-layouts.layout-dashboard title="Ajouter un vêtement enfant">
    <div class="flex">
        <x-layouts.dashboardNav-left/>
        <div class="w-full bg-gray-100">
            <x-dashboard-top currentPage="Ajouter un vêtement enfant"/>
            <div class="py-10 mx-10">
                <h1 class="font-black text-4xl text-gray-700 pb-5">Nouveau vêtement enfant</h1>
