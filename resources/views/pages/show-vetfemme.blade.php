<x-layouts.main-layout title="Vêtement Femme">
    ...
    <x-nav-femmes/>
    {{-- section product --}}
    <div class="xl:my-28 sm:mb-28 xl:flex text-gray-700">
        {{-- for lg --}}
        ...
        @endif
        <img src="{{ asset('storage/'.$femme->url_img) }}" alt="{{ $femme->name }}" class="sm:max-w-[80%] md:max-w-sm lg:max-w-md md:mx-10 md:my-5 sm:m-5 lg:mx-48f xl:mx-5">
        {{-- for sm --}}
        @if (count($femme->images) != 0)
        ...
        <div class="sm:mx-5 md:mx-10">
            <h1 class="lg:text-5xl sm:text-xl md:text-3xl pb-3">{{ $femme->name }}</h1>
